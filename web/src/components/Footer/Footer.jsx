          ...
          <ul className="flex flex-col space-y-4 lg:space-y-0 lg:flex-row items-start lg:items-center justify-start lg:space-x-4">
            ...
            <li className="group relative ">
              ...
              <ul className="group-hover:flex hidden flex-col ml-7 lg:ml-0 gap-2 min-w-[200px] p-6 rounded-2xl bg-white absolute bottom-4 translate-x-[-50%] left-2/4 ">
                <li className=" font-Public_Sans font-normal text-sm leading-[20px] tracking-[0.03em] text-gray-600 hover:text-gray-900 hover:font-bold cursor-pointer">
                  About Us
                </li>
                <li className=" font-Public_Sans font-normal text-sm leading-[20px] tracking-[0.03em] text-gray-600 hover:text-gray-900 hover:font-bold cursor-pointer">
                  Meet the Team
            ...
            {/* </li> */}
            <li className=" font-Public_Sans font-normal text-sm leading-[20px] tracking-[0.03em] text-white opacity-70 flex space-x-1 items-center justify-center">
