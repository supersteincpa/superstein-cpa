            ...
            <li className="group flex flex-col lg:flex-row lg:items-center navbar_menu_list_wrapper w-full lg:w-auto">
              ...
              <div className="flex flex-col items-center lg:absolute lg:top-20 lg:left-0 w-full pt-4 pb-0 lg:py-8 bg-gray-900 lg:border-y-[1px] lg:border-y-gray-800">
                <div className="w-full lg:w-fit">
                  <Link
                    to="/services"
                    className="hover:text-addition_button_color text-base lg:text-xl leading-6 lg:leading-[30px] font-normal font-Public_Sans text-white tracking-[0.03em]"
                  >
                    Services
                  </Link>
                    ...
                    {orderedNodes.map(({ title, slug: { current } }, index) => {
                      return (
                        <Link
                          key={index}
                          to={`/${current}`}
                          className="hover:text-addition_button_color text-base leading-6 font-normal font-Public_Sans text-white tracking-[0.03em]"
                        >
                          {title}
                        </Link>
                      )
