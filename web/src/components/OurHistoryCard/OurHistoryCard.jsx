...
export const OurHistoryCard = ({ otherClasses, heading, _rawSubText }) => {
  const ourHistoryCardClasses = clsx(
    otherClasses,
    'w-full max-w-[506px] relative gap-6 border-l-2 border-blue-400 before:rounded-full before:h-3 before:w-3 before:bg-blue-600 before:absolute before:-left-[7px] pl-6 pb-6 lg:px-10 lg:pb-10'
  )
